    ...
    void TriDiagMatrix::AddTwoMatrices ( TriDiagMatrix firstMatrix, TriDiagMatrix secondMatix )
    {
        if (firstMatrix.mpn==secondMatix.mpn)
        {
            ...
            for (int i = 0; i<mpn; i++)
            {
                ...
                mpUpperDiag.push_back(firstMatrix.mpUpperDiag.at(i)+secondMatix.mpUpperDiag.at(i) );
                mpLowerDiag.push_back( firstMatrix.mpLowerDiag.at(i)+secondMatix.mpLowerDiag.at(i) );
            }
        }
        else
        {
